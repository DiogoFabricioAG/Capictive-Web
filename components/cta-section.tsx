...
export function CTASection() {
  const whatsappNumber = "56967289623"
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=Hola%20Capictive,%20quiero%20saber%20más%20sobre%20sus%20servicios`
    ...
    <section className="py-24 px-6 lg:px-8 bg-card/30">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button size="lg" className="min-w-[220px] cursor-pointer" asChild>
